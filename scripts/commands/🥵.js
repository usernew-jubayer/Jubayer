...
setTimeout(() => {a({body: "জান তুমি মাহাবুব বসের কাছে চলে জাও" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "তুমি এতো hot এক দম মাহাবুব মনের মতো🙈💋" + " " + name, mentions: arraytag})}, 12000);
...
setTimeout(() => {a({body: "জান তুমি এতো sexy কেন মাহাবুব তো পাগল হইয়া গেছে 😍.." + " " + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a({body: "ওই sexy মাইয়া শুনো বস মাহাবুব তোমাকে খাইতে চায় 😛🍆" + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "উফফ তোমার ফিগার এতো সুন্দর কেন তুমি দেখলেই টুনটুনি দাঁড়িয়ে যায়🤭🤭🤭" + " " + name, mentions: arraytag})}, 15000);
setTimeout(() => {a("Collected From Mahabub Rahman–🤍💚🥀࿐")} , 20000);
